...
>Это классический XSS-payload для кражи файла с сервера жертвы. Этот скрипт сохраняется на сайте и сразу не выполняется. Он выполнится в браузере на компьютере администратора, а именно отправит http://127.0.0.1/dir/pass.txt к нам на наш открытый порт http://192.168.180.184:9002
