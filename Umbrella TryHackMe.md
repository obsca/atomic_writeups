...
Я почитал про так называемые **digest** теперь все стало понятно. нам нужно вытянуть архив самого приложения. я нашел все по той же ссылке как взять слой необходимый, что бы наше приложение стянуть к себе на пк, через curl.
...
<img width="535" height="570" alt="Pasted image 20251229182435" src="https://github.com/user-attachments/assets/faddcde3-c771-4db4-8783-42eb22935a03" />
